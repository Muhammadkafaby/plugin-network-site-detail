...
== Description ==
Network Site Details is a WordPress plugin that helps network admins manage and export multisite data efficiently. It collects data from all subsites in your multisite network and provides features to export the data in Excel format. Version 1.0 is the initial release and will be further developed in the future.

== Installation ==
1. Upload the plugin files to the `/wp-content/plugins/` directory, or install the plugin through the WordPress plugins screen directly.
2. Activate the plugin through the 'Plugins' screen in WordPress.
3. Access the dashboard via Network Admin > Dashboard.
